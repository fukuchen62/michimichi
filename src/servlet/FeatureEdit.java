...
//		}
		//全記事を読み込み
//							List<FeatureListLogic> featureList = featureList.getFeatureList(0);
...
//	RequestDispatcher dispatcher = request.getRequestDispatcher(forward);dispatcher.forward(request,response);
...
//				boolean bret = featureListLogic.deleteFeatureList(feature_type_id);
//
//				if (bret == false) {
//					request.setAttribute("errorMsg", "削除時にエラーが発生しました。");
//				//該当データを読み込む
//					feature = featureListLogic.getFeatureList(feature_type_id);
//					request.setAttribute("feature", feature);
//					forward = "/WEB-INF/jsp/featureEdit.jsp";
//				} else {
