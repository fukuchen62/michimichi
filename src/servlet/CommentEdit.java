...
//				List<CommentBs> AdminCommentList = commentLogic.getAdminCommentsById(station_id);
...
//				forward = "WEB-INF/jsp/cms/comment_edit.jsp";
			...
			if (comment_id > 0) {
				...
				//				System.out.println("CommentEdit comment_id:"+comment_id);

				//メニュー編集
				//指定したfeature_idで該当特集を読み込む
				//				Feature feature = featureListLogic.getFeatureById(comment_id);
				//
				//				if (feature != null) {
