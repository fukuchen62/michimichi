...
function featureShowChange(id, showflag, title) {
	...
	/*comment_idを送信フォームに代入*/
	target= document.getElementById("comment_id"); /*id名変えた*/
	target.value = id;
...
window.onload = function() {
	...
	for (var i = 0; i < btnshow.length; i++) {
		btnshow[i].onclick = function(comment_id, showflag) {*/
	/*モーダル画面表示させる*/
			/*modal.style.display = "block";
		}
	}*/
