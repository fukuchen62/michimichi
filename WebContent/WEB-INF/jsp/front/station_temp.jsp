...
<c:import url="../layout/template.jsp">
	...
	<c:param name="content">
		...
		<section id="introduction">
			<h1>
				<img src="img/temp/station_h1_pc1.svg"
					srcset="img/temp/station_h1_tab.svg 1024w,
             img/temp/station_h1_pc2.svg 1350w,
             img/temp/station_h1_pc1.svg 1920w"
					alt="intro_h1"> <span>道の駅 ${station.michinoeki_name}</span>
			</h1>
			...
			<div class="container">
				<div class="wrap">
					...
					<div class="pc">
						<figure>
							<div id="slider-v" class="slider-pro">
								<div class="sp-slides">
									<div class="sp-slide">
										<img class="sp-image" src="${station.photo_path1}"
											alt="${station.alt1}">
									</div>
									<div class="sp-slide">
										<img class="sp-image" src="${station.photo_path2}"
											alt="${station.alt2}">
									</div>
									<div class="sp-slide">
										<img class="sp-image" src="${station.photo_path3}"
											alt="${station.alt3}">
									</div>
									<div class="sp-slide">
										<img class="sp-image" src="${station.photo_path4}"
											alt="${station.alt4}">
									</div>
								</div>

								<div class="sp-thumbnails">
									<img class="sp-thumbnail" src="${station.photo_thum_path1}"
										alt="${station.alt1}"> <img class="sp-thumbnail"
										src="${station.photo_thum_path2}" alt="${station.alt2}">
									<img class="sp-thumbnail" src="${station.photo_thum_path3}"
										alt="${station.alt3}"> <img class="sp-thumbnail"
										src="${station.photo_thum_path4}" alt="${station.alt4}">
								</div>
							</div>

							<figcaption class="station-desc intro-desc">
								${station.explanation}</figcaption>
						</figure>
					</div>
						...
						<figure>
							...
							<div class="slider">
								<div class="slide-01 parent">
									<img class="img" src="${station.photo_thum_path1}"
										alt="${station.alt1}">
								</div>
								<div class="slide-02 parent">
									<img class="img" src="${station.photo_thum_path2}"
										alt="${station.alt2}">
								</div>
								<div class="slide-03 parent">
									<img class="img" src="${station.photo_thum_path3}"
										alt="${station.alt3}">
								</div>
								<div class="slide-04 parent">
									<img class="img" src="${station.photo_thum_path4}"
										alt="${station.alt4}">
								</div>
							</div>
					...
					<div class="account flexR">
						<a class="comment" href="#comment">コメント欄へ(10)</a> <span
							class="good">いいね！♡ 12</span>
					</div>
				</div>
			</div>
		</section>
		...
		<section id="pick-up">
			<h2>
				<img
					srcset="img/temp/station_h2_sp.png 1024w,
            img/temp/station_h2_pc2.png 1024w,
            img/temp/station_h2_pc1.png 1350w"
					src="img/temp/station_h1_pc1.png" alt="pickup_h2"> <span>特色</span>
			</h2>
			...
			<div class="container">
				<div class="wrap">
					<div class="pc">
						<figure class="flexC">
							<img class="img" src="${station.feature1_photo_path}"
								alt="${station.feature1_alt}">
							<figcaption class="station-desc pickup-desc">
								${station.feature1_overview}</figcaption>
						</figure>

						<figure class="flexC">
							<img class="img" src="${station.feature2_photo_path}"
								alt="${station.feature2_alt}">
							<figcaption class="station-desc pickup-desc">
		...
		<section id="recommend">
            ...
            img/temp/station_h2_pc2.png 1024w,
            img/temp/station_h2_pc1.png 1350w"
					src="img/temp/station_h1_pc1.png" alt="recommend_h2"> <span>オススメ</span>
			</h2>
					...
					<div class="pc">
						<div class="upper-row">
							<c:forEach var="rec" items="${RecommendsList}" end="2">
								<figure class="flexC">
									<img class="img" src="${rec.recommend_photo_path }"
										alt="${rec.recommend_alt}">
		...
		<section id="spot">
            ...
            img/temp/station_h2_pc2.png 1024w,
            img/temp/station_h2_pc1.png 1350w"
					src="img/temp/station_h1_pc1.png" alt="spot_h2"> <span>スポット</span>
			</h2>
		...
		<section id="feature">
            ...
            img/temp/station_h2_pc2.png 1024w,
            img/temp/station_h2_pc1.png 1350w"
					src="img/temp/station_h1_pc1.png" alt="feature_h2"> <span>特集リンク</span>
			</h2>

			<div class="container">
				<div class="wrap">
					<a href="CtrlForFront?pge_id=4&con_id=${station.feature_banner1}"><img
						src="" alt="feature_01"></a> <a
						href="CtrlForFront?pge_id=4&con_id=${station.feature_banner2}"><img
						src="" alt="feature_02"></a> <a
						href="CtrlForFront?pge_id=4&con_id=${station.feature_banner3}"
						class="pc"><img src="" alt="feature_03"></a>
				</div>
			</div>
		</section>
		...
		<section id="information">
            ...
            img/temp/station_h2_pc2.png 1024w,
            img/temp/station_h2_pc1.png 1350w"
					src="img/temp/station_h1_pc1.png" alt="info_h2"> <span>施設案内</span>
			</h2>
				...
				<div class="wrap">
					<div class="info">
						<table>
							...
							<tr>
								<th>所在地</th>
								<td class="postal-code">${station.post_code}
									${station.address}</td>
							</tr>
							<tr>
								<th>TEL</th>
								<td class="tel">${station.tel}</td>
							</tr>
							<tr>
								<th>駐車場</th>
								<td class="parking">${station.parking}</td>
							</tr>
							<tr>
								<th>営業時間</th>
							...
							<tr>
								<th>定休日</th>
								<td class="regular-holiday">${station.closed}</td>
							</tr>
							<tr>
								<th>HP</th>
								<td class="url"><a href="${station.url}" target="_blank"
									rel="noopener noreferrer"> ${station.url} </a></td>
							</tr>
							<tr>
								<th>設備</th>
								<td class="facility">
		...
		<section id="map">
			<div class="container">${station.iframe_src}</div>
		</section>
		...
		<section id="comment">
            ...
            img/temp/station_h2_pc2.png 1024w,
            img/temp/station_h2_pc1.png 1350w"
					src="img/temp/station_h1_pc1.png" alt="comment_h2"> <span>コメント</span>
			</h2>
			...
			<div class="container">
				<div class="comment-wrap mt60">
					<div>
						...
						<p class="comment-text">text text text text text text text
					...
					<div class="flexC mt80">
						...
						<div class="name">
							お名前 <input id="comment-name" type="text" name="name">
						</div>

						<textarea id="comment-text" name="textarea" id="" cols="30"
							rows="4"></textarea>
							...
							<div class="comment-modal-area">
								<form action="" method="post">
									<div class="comment-modal-name flexR">
										<span>お名前 ：</span> <span> <input id="res-name"
											type="text" readonly>
										</span>
									</div>

									<div class="comment-modal-text flexR">
										<span>コメント：</span> <span class="res-comment-wrap"> <input
											id="res-text" type="text" readonly>
										</span>
									</div>

									<div class="btn flexR">
										<input class="btn-return" type="button" value="戻る"> <input
											class="btn-submit" type="submit" value="確認">
									</div>
								</form>
							</div>
						</div>
